...
export const casos: Caso[] = [
  {
    ...
    desc: "Red de scraping que consolida eventos culturales de 13 fuentes + agente IA 'Flor' que atiende ciudadanos por WhatsApp.",
    stack: ["Make.com", "OpenAI", "Airtable", "WhatsApp API"],
    problema: "Compás Urbano necesitaba consolidar la agenda cultural de una ciudad desde más de 13 organizaciones distintas. El proceso manual tomaba horas semanales y generaba datos inconsistentes.",
    solucion: "Proyecto 1 — Red de scraping inteligente: 13 automatizaciones en Make.com que extraen eventos de cada fuente, los procesan con OpenAI para estandarizar el formato, y los insertan o actualizan automáticamente en Airtable. El sitio web de Compás Urbano consulta esta base en tiempo real.\n\nProyecto 2 — Agente conversacional 'Flor': Asistente de IA conectado directamente a la base de datos de eventos. Atiende ciudadanos por WhatsApp, responde solo con datos reales (no conocimiento genérico del modelo), y al cerrar la conversación lanza automáticamente una encuesta de satisfacción de 5 preguntas.",
    stats: [
  ...
  },
  {
    ...
    problema: "Formex coordinaba pedidos internacionales desde China con una cadena de correos manuales entre proveedores, bodega y clientes. Cada temporada de catálogo requería decenas de horas de coordinación y era propensa a errores.",
  ...
  },
  {
    ...
    problema: "El equipo de MDO Mortgage registraba manualmente cada llamada y SMS de Dialpad en Bitrix24. Con más de 1.000 interacciones mensuales, esto consumía horas de trabajo y generaba registros incompletos o desactualizados.",
    solucion: "Automatización en Make.com que escucha eventos de Dialpad en tiempo real: cada llamada o SMS entrante dispara un flujo que busca al deudor (y co-deudores) en Bitrix24, crea o actualiza el registro correspondiente, y adjunta el log completo de la interacción. El matching es inteligente — maneja variaciones de número y múltiples contactos asociados a un caso.",
    stats: [
